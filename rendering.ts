...
const TestingPlayer: Player = { absolutePosition: { x: 1, y: 1 }, relativePosition: { x: 0, y: 0 }, sprite: sprites.create(assets.image`player-right`, SpriteKind.Player), maxhealth:100, health:100, attack:5, defense: 5}
